...
class CondDiff(nn.Module):
    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            h, res_samples = downsample_block(hidden_states=h, temb=emb, context=y, cond=cond_emb)
        ...
        # 5. mid
        h = self.middle_block(hidden_states=h, temb=emb, context=y, cond=cond_emb)
        ...
        for upsample_block in self.up_blocks:
            ...
            h = upsample_block(hidden_states=h, res_hidden_states_list=res_samples, temb=emb, context=y, cond=cond_emb)
